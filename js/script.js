	...
	**/
	$("#maps").gmap3({
		 map:{
 		 ...
 		 marker:{
 		 	values : [
 		 		{latLng:[-16.639518, -49.229585],data:'<img src="https://dl.dropboxusercontent.com/u/29545616/Preview/ditinggalrabi.png">',  options:{icon: 'https://dl.dropboxusercontent.com/u/29545616/Preview/location.png'}}
 		 	],
 		 	events : {
